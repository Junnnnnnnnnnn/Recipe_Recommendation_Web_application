...
public class RestTemplateUtil {
    ...
    public static ResponseEntity<JsonVO> post(String imgString) {
        ...
        return restTemplate.postForEntity("http://70.12.229.103:5000/groceryDetection", imgString, JsonVO.class);
    }
    ...
    public static ResponseEntity<LabelJsonVO> postRecomandJsonRsponse(ArrayList<String> label) {
        ...
        return restTemplate.postForEntity("http://70.12.229.103:5000/findRecipeList", label, LabelJsonVO.class);
    }
}